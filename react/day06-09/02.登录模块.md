...
![image.png](../../assets/react/day06-09/03.png)
...
![image.png](../../assets/react/day06-09/04.png)
**实现步骤**
...
![image.png](../../assets/react/day06-09/05.png)
...
![image.png](../../assets/react/day06-09/06.png)

# 请求拦截器注入 token

> 业务背景: Token 作为用户的数据标识，在接口层面起到了接口权限控制的作用，也就是说后端有很多接口都需要通过查看当前请求头信息中是否含有 token 数据，来决定是否正常返回数据

![token.png](../../assets/react/day06-09/07.png)
